export interface BeerKind {
  id: number;
  name: string;
}

export const BEER_KINDS: BeerKind[] = [
  { id: 1, name: "Albae cerevisiae" },
  { id: 2, name: "Altbier" },
  { id: 3, name: "American amber ale" },
  { id: 4, name: "American barleywine" },
  { id: 5, name: "American blonde ale" },
  { id: 6, name: "American brown ale" },
  { id: 7, name: "American IPA" },
  { id: 8, name: "American porter" },
  { id: 9, name: "American stout" },
  { id: 10, name: "American strong ale" },
  { id: 11, name: "American wheat" },
  { id: 12, name: "Angielski porter" },
  { id: 13, name: "Angielskie barley wine" },
  { id: 14, name: "Angielskie pale ale" },
  { id: 15, name: "Australian sparkling ale" },
  { id: 16, name: "Bawarskie ciemne (dunkles)" },
  { id: 17, name: "Bawarskie jasne (helles)" },
  { id: 18, name: "Belgian blond ale" },
  { id: 19, name: "Belgian dark strong ale (quadrupel)" },
  { id: 20, name: "Belgian dubbel" },
  { id: 21, name: "Belgian golden strong ale" },
  { id: 22, name: "Belgian pale ale" },
  { id: 23, name: "Belgian triple" },
  { id: 24, name: "Belgijska IPA" },
  { id: 25, name: "Berliner weisse" },
  { id: 26, name: "Bière de garde" },
  { id: 27, name: "Bitter" },
  { id: 28, name: "British golden ale" },
  { id: 29, name: "British strong ale" },
  { id: 30, name: "Brown IPA" },
  { id: 31, name: "Burton ale" },
  { id: 32, name: "California common" },
  { id: 33, name: "Ciemne lekkie (tmavé výčepní)" },
  { id: 34, name: "Ciemne mocne (tmavý speciál)" },
  { id: 35, name: "Ciemne pełne (tmavý ležák)" },
  { id: 36, name: "Coffee pale ale" },
  { id: 37, name: "Cream ale" },
  { id: 38, name: "Czeskie półciemne (polotmavé)" },
  { id: 39, name: "Dortmunder Export" },
  { id: 40, name: "Double IPA" },
  { id: 41, name: "Dunkles weissbier" },
  { id: 42, name: "Festbier" },
  { id: 43, name: "Festbock" },
  { id: 44, name: "Gose" },
  { id: 45, name: "Grodziskie" },
  { id: 46, name: "Hvidtøl" },
  { id: 47, name: "Imperialny stout" },
  { id: 48, name: "India pale ale" },
  { id: 49, name: "Irish dry stout" },
  { id: 50, name: "Irish red ale" },
  { id: 51, name: "Jasne lekkie (světlé výčepní)" },
  { id: 52, name: "Jasne mocne (světlý speciál)" },
  { id: 53, name: "Jasne pełne (světlý ležák)" },
  { id: 54, name: "Jasny koźlak (helles bock)" },
  { id: 55, name: "Jasny lager" },
  { id: 56, name: "Kellerbier (zwickelbier)" },
  { id: 57, name: "Kentucky common" },
  { id: 58, name: "Kolońskie (kölsch)" },
  { id: 59, name: "Koźlak (bock)" },
  { id: 60, name: "Koźlak dubeltowy (doppelbock)" },
  { id: 61, name: "Koźlak jesienny holenderski (herfstbok)" },
  { id: 62, name: "Koźlak lodowy (eisbock)" },
  { id: 63, name: "Koźlak pszeniczny (weizenbock)" },
  { id: 64, name: "Koźlak wiosenny holenderski (lentebok)" },
  { id: 65, name: "Kristallweizen" },
  { id: 66, name: "Lager wiedeński" },
  { id: 67, name: "Leichtbier" },
  { id: 68, name: "Lichtenhainer" },
  { id: 69, name: "Marcowe" },
  { id: 70, name: "Mild ale" },
  { id: 71, name: "Milk stout" },
  { id: 72, name: "Nowofalowy pils" },
  { id: 73, name: "Oak aged imperial stout" },
  { id: 74, name: "Old ale" },
  { id: 75, name: "Owocowe ale" },
  { id: 76, name: "Pilzner niemiecki" },
  { id: 77, name: "Piwo miodowe (braggot)" },
  { id: 78, name: "Porter bałtycki" },
  { id: 79, name: "Red IPA" },
  { id: 80, name: "Rye wine" },
  { id: 81, name: "Sahti" },
  { id: 82, name: "Saison" },
  { id: 83, name: "Schwarzbier" },
  { id: 84, name: "Stout owsiany" },
  { id: 85, name: "Szkockie ale" },
  { id: 86, name: "Szkockie eksportowe ale" },
  { id: 87, name: "Wędzone marcowe (rauchmaerzen)" },
  { id: 88, name: "Wędzone pszeniczne (rauchweizen)" },
  { id: 89, name: "Wędzony koźlak (rauchbock)" },
  { id: 90, name: "Wędzony porter bałtycki" },
  { id: 91, name: "Wędzony stout" },
  { id: 92, name: "Wee heavy" },
  { id: 93, name: "Weissbier" },
  { id: 94, name: "Wheat IPA" },
  { id: 95, name: "Wheatwine" },
  { id: 96, name: "White IPA" },
  { id: 97, name: "Winogronowe ale" },
  { id: 98, name: "Witbier" },
  { id: 99, name: "Żytnia IPA" },
];
